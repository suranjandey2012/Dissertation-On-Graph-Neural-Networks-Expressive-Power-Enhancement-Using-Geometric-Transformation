...
#Load the dataset
adj, features, dataset, labels, idx_train, idx_val, idx_test = load_Amazon_Dataset(args.device,'Computers',args.train_set_size,args.val_set_size)
...
visualize(out,labels.detach().cpu().numpy(),"/home/mlrl/Suranjan/Custom_GNN/plots/Amazon_Computer/Features Before Training")
...
visualize(out,labels.detach().cpu().numpy(),'/home/mlrl/Suranjan/Custom_GNN/plots/Amazon_Computer/Custom_GNN Final TSNE')
...
axis[0].set_title("Loss vs. Epoch For Amazon_Computers Dataset")
...
axis[1].set_title("Validation Accuracy vs. Epoch For Amazon_Computers Dataset")
...
# Show plot
plt.tight_layout()
plt.savefig(f"/home/mlrl/Suranjan/Custom_GNN/plots/Amazon_Computer/Custom_GNN Training and Validation Accuracy Against Number Of Epochs.png")
plt.close()
