from Load_Dataset import load_Planetoid_Dataset
...
#Load the dataset
adj, features, dataset, labels, idx_train, idx_val, idx_test = load_Planetoid_Dataset(args.device,'CiteSeer')
...
visualize(out,labels.detach().cpu().numpy(),"/home/mlrl/Suranjan/Custom_GNN/plots/Citeseer/Features Before Training")
...
visualize(out,labels.detach().cpu().numpy(),'/home/mlrl/Suranjan/Custom_GNN/plots/Citeseer/Custom_GNN Final TSNE')
...
axis[0].set_title("Loss vs. Epoch For Citeseer Dataset")
...
axis[1].set_title("Validation Accuracy vs. Epoch For Citeseer Dataset")
...
# Show plot
plt.tight_layout()
plt.savefig(f"/home/mlrl/Suranjan/Custom_GNN/plots/Citeseer/Custom_GNN Training and Validation Accuracy Against Number Of Epochs.png")
plt.close()
